...
/**
 * Base class that represents a row from the 'authkey' table.
 *
 *
 *
 * @package    propel.generator.ginger.om
 */
abstract class BaseAuthkey extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'AuthkeyPeer';
    ...
    /**
     * Initializes internal state of BaseAuthkey object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = AuthkeyPeer::ID;
        }
    ...
    /**
     * Set the value of [asso] column.
     *
     * @param string $v new value
     * @return Authkey The current object (for fluent API support)
     */
    public function setAsso($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->asso !== $v) {
            $this->asso = $v;
            $this->modifiedColumns[] = AuthkeyPeer::ASSO;
        }
    ...
    public function setDetails($v)
    {
        ...
        if ($this->details !== $v) {
            $this->details = $v;
            $this->modifiedColumns[] = AuthkeyPeer::DETAILS;
        }
    ...
    /**
     * Set the value of [cle] column.
     *
     * @param string $v new value
     * @return Authkey The current object (for fluent API support)
     */
    public function setCle($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->cle !== $v) {
            $this->cle = $v;
            $this->modifiedColumns[] = AuthkeyPeer::CLE;
        }
    ...
    public function setDroitEcriture($v)
    {
        ...
        if ($this->droit_ecriture !== $v) {
            $this->droit_ecriture = $v;
            $this->modifiedColumns[] = AuthkeyPeer::DROIT_ECRITURE;
        }
    ...
    public function setDroitBadges($v)
    {
        ...
        if ($this->droit_badges !== $v) {
            $this->droit_badges = $v;
            $this->modifiedColumns[] = AuthkeyPeer::DROIT_BADGES;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AuthkeyPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AuthkeyPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AuthkeyPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AuthkeyQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(AuthkeyPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(AuthkeyPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                AuthkeyPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AuthkeyPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(AuthkeyPeer::ASSO)) {
            $modifiedColumns[':p' . $index++]  = '`ASSO`';
        }
        if ($this->isColumnModified(AuthkeyPeer::DETAILS)) {
            $modifiedColumns[':p' . $index++]  = '`DETAILS`';
        }
        if ($this->isColumnModified(AuthkeyPeer::CLE)) {
            $modifiedColumns[':p' . $index++]  = '`CLE`';
        }
        if ($this->isColumnModified(AuthkeyPeer::DROIT_ECRITURE)) {
            $modifiedColumns[':p' . $index++]  = '`DROIT_ECRITURE`';
        }
        ...
        $sql = sprintf(
            'INSERT INTO `authkey` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`ID`':
                        ...
                        break;
                    case '`ASSO`':
                        $stmt->bindValue($identifier, $this->asso, PDO::PARAM_STR);
                        break;
                    case '`DETAILS`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AuthkeyPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AuthkeyPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Authkey'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Authkey'][$this->getPrimaryKey()] = true;
        $keys = AuthkeyPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getAsso(),
            $keys[2] => $this->getDetails(),
            $keys[3] => $this->getCle(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setAsso($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setDetails($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AuthkeyPeer::ID)) $criteria->add(AuthkeyPeer::ID, $this->id);
        if ($this->isColumnModified(AuthkeyPeer::ASSO)) $criteria->add(AuthkeyPeer::ASSO, $this->asso);
        if ($this->isColumnModified(AuthkeyPeer::DETAILS)) $criteria->add(AuthkeyPeer::DETAILS, $this->details);
    ...
    {
        $criteria = new Criteria(AuthkeyPeer::DATABASE_NAME);
        $criteria->add(AuthkeyPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Authkey (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Authkey Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(AuthkeyPeer::DEFAULT_STRING_FORMAT);
    }
